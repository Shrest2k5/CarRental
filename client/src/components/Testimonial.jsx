...
const Testimonial = () => {
  ...
  return (
     <div className="py-28 px-6 md:px-16 xl:px-44">
            
            <Title title="What Our Customers Say" subTitle="Discover why discerning travelers choose StayVenture for their luxury accoommodations around the world."/>
