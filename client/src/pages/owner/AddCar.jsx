      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label >Brand</label>
            <input type="text" placeholder='e.g. BMW, Merceds, Audi...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e=>setCar({...car, brand:e.target.value})}/>
          </div>
      ...
      <label >Location</label>
       ...
       {/* Car Description */}
        <div className='flex flex-col w-full'>
          ...
          <button className='flex items-center gap-2 py-2.5 mt-4 bg-primary text-white rounded-md font-medium w-max cursor-pointer'>
